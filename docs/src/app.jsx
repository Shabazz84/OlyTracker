...
const DAYS_SUMMER = [
  ...
  },
  {
    ...
    maxLoad: false,
    focus:["Front Squat: pause (Ph1) → dynamic (Ph2), ≤80% cap","Belt Squat — back-sparing quad mass","OHS stability"],
    exercises:[
      {id:"muscle_snatch",         sets:2,     reps:"3",      l1:"42–46 kg",   l2:"44–48 kg"  },
      {id:"snatch_balance",        sets:3,     reps:"3",      l1:"35–42 kg",   l2:"40–48 kg"  },
      {id:"front_squat",           sets:"4–6", reps:"1",      l1:"75–82 kg",   l2:"78–82 kg"  },
      {id:"belt_squat",            sets:3,     reps:"10",     l1:"60–80 kg",   l2:"70–90 kg"  },
  ...
  },
  {
    ...
    maxLoad: false,
    focus:["Klokov Squat singles","Belt Squat — back-sparing quad mass","Split / single-leg knees-forward work"],
    exercises:[
      {id:"muscle_snatch",         sets:2,     reps:"3",      l1:"42–46 kg",   l2:"44–48 kg"  },
...
const PROGRAM_B1 = [
  {week:1,phase:"Phase 1",load:"Positions · 80–85%",focus:"Build positions",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Pause FS single (≤80% TM)",load:"feel 78–82 kg",
     secondary:"SB 3×3·35, Belt Squat 3×10·70, RDL 4×6·75, OHS 4×4·40, Plank 3×50s",notes:"MS opener 2×3·42. Hard stop 3pm. PAUSE FS — teach position. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov singles / Belt Squat 3×12",load:"feel 85–95 / 65 kg",
     secondary:"Split Squat 3×8/leg·40, Single-Leg 3×8·BW, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·42. Klokov: daily max single (odd wk). Quad-hypertrophy tissue day — back-sparing"},
  ]},
  {week:2,phase:"Phase 1",load:"Positions · 80–85%",focus:"+2.5 kg from Week 1",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Pause FS single (≤80% TM)",load:"feel 78–82 kg",
     secondary:"SB 3×3·37, Belt Squat 3×10·72, RDL 4×6·77, OHS 4×4·42, Plank 3×50s",notes:"MS opener 2×3·44. Hard stop 3pm. PAUSE FS — teach position. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov 3×3 / Belt Squat 3×12",load:"85 kg / 67 kg",
     secondary:"Split Squat 3×8/leg·42, Single-Leg 3×8·BW, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·44. Klokov: prescribed 3×3 @ 80% (even wk). Quad-hypertrophy tissue day"},
  ]},
  {week:3,phase:"Phase 1",load:"Positions · 80–85%",focus:"Last Phase 1 week. Lock in positions",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Pause FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·38, Belt Squat 3×10·75, RDL 4×6·80, OHS 4×4·44, Plank 3×60s",notes:"MS opener 2×3·44. Hard stop 3pm. PAUSE FS — last week. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov singles / Belt Squat 3×12",load:"feel 90–100 / 70 kg",
     secondary:"Split Squat 3×8/leg·44, Single-Leg 3×8·BW, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·44. Klokov: daily max single (odd wk). Quad-hypertrophy tissue day"},
  ]},
  {week:4,phase:"Phase 2",load:"Load · 85–90%",focus:"Jerk daily max begins. OHS → 4 sets. FS → dynamic",
   note:"First jerk singles: open ~60–62 kg. Auto-reg: no grinding misses. D1 OHS now 4×3. D3 OHS 4×4 throughout. FS switches to DYNAMIC (spring out of the hole, no slow eccentric) — squat power now transfers to the clean recovery (Pavlukhin).",
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Dynamic FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·39, Belt Squat 3×10·77, RDL 4×6·82, OHS 4×4·46, Plank 3×60s",notes:"MS opener 2×3·46. Hard stop 3pm. DYNAMIC FS — fast out of the hole. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov 3×3 / Belt Squat 3×12",load:"87 kg / 72 kg",
     secondary:"Split Squat 3×8/leg·46, Single-Leg 3×8·BW+DB, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·46. Klokov: prescribed 3×3 @ 80% (even wk). Quad-hypertrophy tissue day"},
  ]},
  {week:5,phase:"Phase 2",load:"Load · 85–90%",focus:"Jerk auto-reg familiar. Push higher",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Dynamic FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·40, Belt Squat 3×10·80, RDL 4×6·85, OHS 4×4·48, Plank 3×65s",notes:"MS opener 2×3·46. Hard stop 3pm. DYNAMIC FS — fast out of the hole. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov singles / Belt Squat 3×12",load:"feel 96–105 / 75 kg",
     secondary:"Split Squat 3×8/leg·48, Single-Leg 3×8·BW+DB, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·46. Klokov: daily max single (odd wk). Quad-hypertrophy tissue day"},
  ]},
  {week:6,phase:"Phase 2",load:"Load · 85–90%",focus:"Phase 2 peak. Prepare for deload",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Dynamic FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·42, Belt Squat 3×10·82, RDL 4×6·88, OHS 4×4·50, Plank 3×65s",notes:"MS opener 2×3·48. Hard stop 3pm. DYNAMIC FS — fast out of the hole. FS held ≤80% (Wed cap)"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Klokov 3×3 / Belt Squat 3×12",load:"90 kg / 78 kg",
     secondary:"Split Squat 3×8/leg·50, Single-Leg 3×8·BW+DB, Face Pull 3×15, Ab Wheel 3×8",notes:"MS opener 2×3·48. Klokov: prescribed 3×3 @ 80% (even wk). Quad-hypertrophy tissue day"},
  ]},
  {week:7,phase:"Deload",load:"Same loads · Sets −40%",focus:"Volume −40%. No PRs. Technique priority",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"Dynamic FS 3×1",load:"85 kg",
     secondary:"SB 2×3·36, Belt Squat 2×10·70, RDL 2×6·80, OHS 2×4·44, Plank 2×60s",notes:"MS opener 2×3·44. Hard stop 3pm. Dynamic FS"},
    ...
    {id:"d5",label:"D5 Sat ⭐⭐ ☀️",primary:"Belt Squat 2×12",load:"68 kg",
     secondary:"Split Squat 2×8/leg·44, Single-Leg 2×8·BW, Face Pull 2×15",notes:"MS opener 2×3·44. No Klokov singles. Deload volume"},
  ]},
