...
const DAYS_SUMMER = [
  ...
  },
  {
    ...
    maxLoad: false,
    focus:["Front Squat ≤80% TM (Wed cap)","Posterior chain","OHS stability"],
    exercises:[
      {id:"muscle_snatch",         sets:2,     reps:"3",      l1:"42–46 kg",   l2:"44–48 kg"  },
...
const PROGRAM_B1 = [
  {week:1,phase:"Phase 1",load:"Positions · 80–85%",focus:"Build positions",
   note:"Start conservative. Position over load. Jerk: prescribed 4×2·52. D1 OHS: 3×3. D3: SB+OHS 4×4 from wk 1.",
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 78–82 kg",
     secondary:"SB 3×3·35, RDL 4×6·75, GHR 3×10·BW, OHS 4×4·40, Plank 3×50s",notes:"MS opener 2×3·42. Hard stop 3pm. FS held ≤80% (Wed cap)"},
  ...
  {week:2,phase:"Phase 1",load:"Positions · 80–85%",focus:"+2.5 kg from Week 1",
   note:"Same structure, loads up. Jerk: 4×2·55. D1 OHS: 3×3. D3: SB+OHS 4×4.",
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 78–82 kg",
     secondary:"SB 3×3·37, RDL 4×6·77, GHR 3×10·BW, OHS 4×4·42, Plank 3×50s",notes:"MS opener 2×3·44. Hard stop 3pm. FS held ≤80% (Wed cap)"},
  ...
  {week:3,phase:"Phase 1",load:"Positions · 80–85%",focus:"Last Phase 1 week. Lock in positions",
   note:"Confirm positions are solid before Phase 2. Jerk: 4×2·57. D1 OHS: 3×3. D3: SB+OHS 4×4.",
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·38, RDL 4×6·80, GHR 3×10·BW, OHS 4×4·44, Plank 3×60s",notes:"MS opener 2×3·44. Hard stop 3pm. FS held ≤80% (Wed cap)"},
  ...
  {week:4,phase:"Phase 2",load:"Load · 85–90%",focus:"Jerk daily max begins. OHS → 4 sets",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·39, RDL 4×6·82, GHR 3×10·5, OHS 4×4·46, Plank 3×60s",notes:"MS opener 2×3·46. Hard stop 3pm. FS held ≤80% (Wed cap)"},
  ...
  {week:5,phase:"Phase 2",load:"Load · 85–90%",focus:"Jerk auto-reg familiar. Push higher",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·40, RDL 4×6·85, GHR 3×10·5, OHS 4×4·48, Plank 3×65s",notes:"MS opener 2×3·46. Hard stop 3pm. FS held ≤80% (Wed cap)"},
  ...
  {week:6,phase:"Phase 2",load:"Load · 85–90%",focus:"Phase 2 peak. Prepare for deload",
   ...
   days:[
    ...
    {id:"d3",label:"D3 Wed ⭐⭐",primary:"FS single (≤80% TM)",load:"feel 80–82 kg",
     secondary:"SB 3×3·42, RDL 4×6·88, GHR 3×10·8, OHS 4×4·50, Plank 3×65s",notes:"MS opener 2×3·48. Hard stop 3pm. FS held ≤80% (Wed cap)"},
